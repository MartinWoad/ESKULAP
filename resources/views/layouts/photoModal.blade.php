                            ...
                            <td class="text-center">
                                <div class="pic-container" onmouseover ="showDeleteIcon(this);" onmouseout="hideDeleteIcon(this);">
                                    <form class="form" role="form" action='funkcje' method="POST">
                                        ...
                                        <a href="{{ $zdjecie->directory }}" data-title="Zdjęcie oryginalne z dnia {{ $zdjecie->data }}" data-lightbox="{{ $zdjecie->id }}">
                                ...
                                <td class="text-center">
                                    <div class="pic-container" onmouseover="showDeleteIcon(this);" onmouseout="hideDeleteIcon(this);">
                                        <form class="form" role="form" action='funkcje' method="POST">
                                            ...
                                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                            <input type="hidden" name="action" value="deletePhoto">
                                            <a href="{{ DB::table('coloured')->where('original_id', $zdjecie->id)->first()->directory }}" data-title="Zdjęcie pokolorowane z dnia {{ $zdjecie->data }}" data-lightbox="{{ $zdjecie->id }}c">
